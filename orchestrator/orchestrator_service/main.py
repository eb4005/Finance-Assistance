...
#     """Parse earnings data from context strings"""
#     earnings = {}
#     for item in context:
#         # Look for earnings beat patterns
#         if '% earnings beat' in item.lower():
#             try:
#                 # Extract company name (first word before numbers)
...
#     # Extract earnings from context if API returns empty
...
#     query_text = "What's our Asia tech exposure?"  # Default fallback
#     brief = {}
#     audio_base64 = None
#     errors = []
...
#                     query_text = stt_result.get("transcript") or query_text
#                 else:
